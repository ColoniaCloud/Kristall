...
const lines = [
  ...
  '            {!inStock ? (',
  '              <span className="text-[10px] bg-amber-50 border border-amber-200 text-amber-600 rounded px-2 py-0.5">Pr\u00f3ximamente</span>',
  '            ) : (',
...
fs.writeFileSync('c:/Users/JMGarrido/kristall-web/components/product/ProductCard.tsx', lines.join('\n'), 'utf8');
console.log('OK');
