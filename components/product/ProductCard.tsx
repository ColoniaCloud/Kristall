...
import { getLinea, productoNombre, productoSlug, productoDestacadaSrc, lineaDestacadaSrc, lineaLogoSrc, type Producto } from '@/lib/catalogo'
...
export default function ProductCard({ producto }: ProductCardProps) {
  ...
  return (
    <AnimatedBorderCard borderRadius={12} className="h-full">
      <Link href={`/productos/lineas/${producto.lineaSlug}/${productoSlug(producto)}`} className="block h-full">
