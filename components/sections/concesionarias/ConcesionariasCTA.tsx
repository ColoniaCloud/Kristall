      ...
      <section className="relative overflow-hidden bg-[#0A0A0A] py-[88px] px-10">
        ...
        >
          ...
          <div
            ...
            style={{ opacity: inView ? 1 : 0, transform: inView ? 'translateY(0)' : 'translateY(12px)', transitionDelay: '240ms' }}
          >
            <button
              type="button"
              onClick={() => setModalOpen(true)}
              className="btn-primary text-white px-8 py-3.5 rounded-lg text-sm font-medium transition-all"
            >
