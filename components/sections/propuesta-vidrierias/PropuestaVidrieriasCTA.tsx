...
function ContactForm() {
  const t = useTranslations('propuesta_vidrierias_form')
    ...
    <div className="relative w-full bg-white/[0.03] border border-white/10 rounded-2xl p-8 backdrop-blur-md">
      {sent ? (
        <div className="text-center py-6">
          ...
          <p className="text-[14px] text-white/50">{t('success_body')}</p>
        </div>
      ) : (
        <>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              <label htmlFor="propuesta-nombre" className="block text-[12px] font-semibold text-white/50 mb-1.5 uppercase tracking-wide">
                {t('label_name')} *
              </label>
              <input
                id="propuesta-nombre"
            ...
            <div>
              <label htmlFor="propuesta-email" className="block text-[12px] font-semibold text-white/50 mb-1.5 uppercase tracking-wide">
                {t('label_email')} *
              </label>
              <input
                id="propuesta-email"
            ...
            <div>
              <label htmlFor="propuesta-telefono" className="block text-[12px] font-semibold text-white/50 mb-1.5 uppercase tracking-wide">
                {t('label_phone')}
              </label>
              <input
                id="propuesta-telefono"
                type="tel"
                value={form.telefono}
